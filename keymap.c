...
qk_tap_dance_action_t tap_dance_actions[] = {
	...
	[TD_GRT] = ACTION_TAP_DANCE_FN(dotdot),//                       one dot, two greter than, three double dot
	[TD_Q] = ACTION_TAP_DANCE_FN(slash),//                          one slash, two question mark, three double slash
	...
	[TD_UND] = ACTION_TAP_DANCE_FN(under),//                        one minus, two underscore, three F11, four double minus
	...
	[TD_TWO] = ACTION_TAP_DANCE_FN(tweet),//                        the top row follows this pattern with exception of minus and equal
